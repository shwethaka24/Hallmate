...
<div class="container-fluid">
	<p><b>Hall : </b><?php echo isset($room['room']) ? $room['room'] : 'NA' ?></p>
	<p><b>Hall Category : </b><?php echo $cat['name'] ?></p>
	<p><b>Hall Price : </b><?php echo '$'.number_format($cat['price'],2) ?></p>
	...
	<p><b>Amount (Price * Days) : </b><?php echo 'LKR'.number_format($cat['price'] * $calc_days ,2) ?></p>
